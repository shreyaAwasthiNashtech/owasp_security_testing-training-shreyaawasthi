# OWASP Security Training Assignment
## Objective of the Assignment

The objective of this assignment was to perform a basic security assessment of the OWASP Juice Shop application by testing specified OWASP Top 10 vulnerability categories.
The purpose was to understand how common web application vulnerabilities work in real applications, how they can be identified during testing, and how they should be documented from a QA and security testing perspective.

This assignment also helped in learning how to:

- Use Burp Suite for intercepting and modifying requests
- Identify insecure application behaviour
- Analyse security weaknesses in application design and configuration
- Understand the impact of vulnerable third-party components
- Document findings in a professional security testing format
- 
**Tasks Completed**
**1. Broken Access Control & Injection**
- Modified intercepted review requests using Burp Suite
- Changed review author details to impersonate another user
- Accessed hidden administration functionality through endpoint manipulation
- Explored administrative functionality exposed in application files
- Deleted 5-star reviews after gaining access to admin features

**3. Security Misconfiguration**
- Captured HTTP responses using Burp Suite
- Checked important HTTP security headers in application responses
- Identified missing and outdated security header configurations
- Accessed exposed directories directly through the browser:
/ftp
/encryptionkeys
- Reviewed publicly accessible internal file
- Analysed how exposed files could help attackers gather sensitive information

**4. Software Supply Chain Failures**
- Downloaded the exposed package.json.bak file from the /ftp directory
- Reviewed application dependencies and package versions
- Identified outdated and vulnerable third-party packages
- Analysed security risks related to vulnerable dependencies
- Observed how exposed dependency information can support supply chain attacks
- Learned the importance of dependency management and regular vulnerability scanning

**5. Insecure Design**
- Automated customer feedback requests using Burp Intruder
- Replayed multiple requests within a short period of time
- Tested captcha reuse handling behaviour
- Observed insufficient anti-automation protection
- Manipulated cart quantity values using negative integers
- Successfully created an order with invalid pricing behaviour
- Identified weaknesses in business logic validation and abuse prevention controls

  
## Key Learnings
- Security testing is not limited to login pages and authentication checks
- Small configuration mistakes can expose highly sensitive information
- Client-side validation alone is never enough for security
- Business logic vulnerabilities can sometimes cause major financial impact
- Publicly exposed files may reveal valuable attacker information
- Third-party libraries can introduce serious risks into applications
- Security testing should begin early in the software development lifecycle
- Burp Suite is a very useful tool for understanding how web applications handle requests and responses
- Proper server-side validation and access control checks are critical in secure applications
- Security issues can exist even when the application appears to work correctly from a functional perspective
